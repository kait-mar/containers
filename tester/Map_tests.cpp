...
#include "../ft_contaners/containers/map.hpp"       // your Map path.
#include "../ft_contaners/containers/vector.hpp" // your Vector path.
#include "../ft_contaners/STL/utility.hpp"  // path to ft::pair.
